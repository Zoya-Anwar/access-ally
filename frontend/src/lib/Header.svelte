<script>
	import Footsteps from './FootstepsIcon.svelte';
</script>
...
>
	<button on:click class="flex items-center mb-4 md:mb-0 text-white/70">
		<Footsteps />
		<div class="text-2xl md:text-xl font-bold ml-2">Access Ally</div>
	</button>
	<a
		class="bg-white/20 hover:bg-white/50 shadow text-white hover:text-green-600 font-medium rounded p-2 text-sm flex items-center"
